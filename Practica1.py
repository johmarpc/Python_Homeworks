...
monto = ("Cantidad de monto ")
cuotas =  ("Cantidad de cuotas ")
porcentaje =  ("Porcentaje de interés anual ")

cuota_mensual = monto * ((porcentaje * ((1 + porcentaje) * cuotas)) / (
            ((1 + porcentaje) ** cuotas) - 1))
    amortizacion = cuota_mensual - (monto * porcentaje)

    print("monthly fee: ", int(cuota_mensual))
    print("Amortized fee: ", int(amortizacion))